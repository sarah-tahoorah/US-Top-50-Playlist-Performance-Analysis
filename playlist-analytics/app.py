...
# ---------------------------------------------------------------------- login
authenticated, display_name, authenticator = login()
if not authenticated:
    st.title("🎧 US Top 50 Playlist Analytics")
    st.caption("Atlantic Recording Corporation — internal analytics. Sign in to continue.")
    st.stop()
